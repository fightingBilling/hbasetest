...
public class AggregateImplementation<T, S, P extends Message, Q extends Message, R extends Message> extends
		AggregateService implements CoprocessorService, Coprocessor {
	 ...
	 * <p>
	 * The average is computed in AggregationClient#avg(byte[],
	 * ColumnInterpreter, Scan) by processing results from all regions, so its
	 * "ok" to pass sum and a Long type.
	 */
	@Override
