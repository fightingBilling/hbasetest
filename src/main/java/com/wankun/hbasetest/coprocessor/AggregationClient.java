...
public class AggregationClient {
	 ...
	 */
	public <R, S, P extends Message, Q extends Message, T extends Message> R max(final TableName tableName,
	 ...
	 *             thrown & propagated to it.
	 */
	public <R, S, P extends Message, Q extends Message, T extends Message> R max(final HTable table,
			final ColumnInterpreter<R, S, P, Q, T> ci, final Scan scan) throws Throwable {
	 ...
	 * @throws Throwable
	 */
	public <R, S, P extends Message, Q extends Message, T extends Message> R min(final TableName tableName,
			final ColumnInterpreter<R, S, P, Q, T> ci, final Scan scan) throws Throwable {
		HTable table = null;
		try {
			table = new HTable(conf, tableName);
	 ...
	 * @throws Throwable
	 */
	public <R, S, P extends Message, Q extends Message, T extends Message> R min(final HTable table,
			final ColumnInterpreter<R, S, P, Q, T> ci, final Scan scan) throws Throwable {
		final AggregateRequest requestArg = validateArgAndGetPB(scan, ci, false);
	 ...
	 * @throws Throwable
	 */
	public <R, S, P extends Message, Q extends Message, T extends Message> long rowCount(final TableName tableName,
			final ColumnInterpreter<R, S, P, Q, T> ci, final Scan scan) throws Throwable {
		HTable table = null;
		try {
			table = new HTable(conf, tableName);
	 ...
	 * @throws Throwable
	 */
	public <R, S, P extends Message, Q extends Message, T extends Message> S sum(final TableName tableName,
			final ColumnInterpreter<R, S, P, Q, T> ci, final Scan scan) throws Throwable {
		HTable table = null;
		try {
			table = new HTable(conf, tableName);
	 ...
	 * @throws Throwable
	 */
	public <R, S, P extends Message, Q extends Message, T extends Message> S sum(final HTable table,
			final ColumnInterpreter<R, S, P, Q, T> ci, final Scan scan) throws Throwable {
		final AggregateRequest requestArg = validateArgAndGetPB(scan, ci, false);
	...
	private <R, S, P extends Message, Q extends Message, T extends Message> Pair<S, Long> getAvgArgs(
			final TableName tableName, final ColumnInterpreter<R, S, P, Q, T> ci, final Scan scan) throws Throwable {
		HTable table = null;
		try {
			table = new HTable(conf, tableName);
	 ...
	 * @throws Throwable
	 */
	public <R, S, P extends Message, Q extends Message, T extends Message> double avg(final TableName tableName,
	 ...
	 * @throws Throwable
	 */
	public <R, S, P extends Message, Q extends Message, T extends Message> double avg(final HTable table,
			final ColumnInterpreter<R, S, P, Q, T> ci, Scan scan) throws Throwable {
	 ...
	 * @throws Throwable
	 */
	public <R, S, P extends Message, Q extends Message, T extends Message> double std(final TableName tableName,
	 ...
	 * @throws Throwable
	 */
	public <R, S, P extends Message, Q extends Message, T extends Message> double std(final HTable table,
			ColumnInterpreter<R, S, P, Q, T> ci, Scan scan) throws Throwable {
	...
	private <R, S, P extends Message, Q extends Message, T extends Message> Pair<NavigableMap<byte[], List<S>>, List<S>> getMedianArgs(
		...
		class StdCallback implements Batch.Callback<List<S>> {
			...
			public Pair<NavigableMap<byte[], List<S>>, List<S>> getMedianParams() {
				...
				l.add(sumVal);
				l.add(sumWeights);
				Pair<NavigableMap<byte[], List<S>>, List<S>> p = new Pair<NavigableMap<byte[], List<S>>, List<S>>(map,
						l);
				return p;
			}
	 ...
	 * @throws Throwable
	 */
	public <R, S, P extends Message, Q extends Message, T extends Message> R median(final TableName tableName,
			ColumnInterpreter<R, S, P, Q, T> ci, Scan scan) throws Throwable {
		HTable table = null;
		try {
			table = new HTable(conf, tableName);
	...
	<R, S, P extends Message, Q extends Message, T extends Message> AggregateRequest validateArgAndGetPB(Scan scan,
			ColumnInterpreter<R, S, P, Q, T> ci, boolean canFamilyBeAbsent) throws IOException {
